  ...
  <div class="bg-white rounded-lg p-5 shadow-md w-full">
    <vee-form :validation-schema="schema" validate-on-input>
      ...
      <div class="mb-6">
        ...
        <ErrorMessage name="image_upload" class="text-xs text-rose-500 mt-1"/>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
        ...
        <div>
          ...
          <ErrorMessage name="full_name" class="text-xs text-rose-500 mt-1"/>
        </div>
        ...
        <div>
          ...
          <ErrorMessage name="email" class="text-xs text-rose-500 mt-1"/>
        </div>
        ...
        <div>
          ...
          <ErrorMessage name="phone" class="text-xs text-rose-500 mt-1"/>
        </div>
      </div>
      ...
      <div class="mb-6">
        ...
        <ErrorMessage name="address" class="text-xs text-rose-500 mt-1"/>
      </div>
